...
/*
 * LOGIK x BLM x NiftyGateway: Roses
 *
 * Created: June 2, 2021
 * Author: Jack Kasbeer
...
contract LOGIKRoses is ERC721, Ownable {
	...
	function mintRoses(address recipient) public onlyOwner returns (uint256)
	{
		...
		uint256 newRosesId = _tokenIds.current();
		_safeMint(recipient, newRosesId);
